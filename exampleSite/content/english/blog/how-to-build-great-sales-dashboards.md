...
3. Collect the data via API-Calls from the platforms in use (or via e.g. [Fivetran](https://fivetran.com))
...
Preferably, all relevant data (ideally from all systems in your company) will be or is already stored in one common data lake. Have a look at [Microsoft ‘s Azure Data Lake](https://azure.microsoft.com/) or [Googles BigQuery](https://cloud.google.com/bigquery) for how this could look like.
